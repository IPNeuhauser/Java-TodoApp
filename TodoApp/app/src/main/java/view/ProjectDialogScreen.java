        ...
        jPanelProjectLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelProjectLayout.createSequentialGroup()
                ...
                .addGroup(jPanelProjectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPaneDescription, javax.swing.GroupLayout.DEFAULT_SIZE, 423, Short.MAX_VALUE)
                    .addGroup(jPanelProjectLayout.createSequentialGroup()
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        try {
            if(!jTextFieldName.getText().equals("")){
                // Cria um novo projeto e armazena as informações fornecidas nele
                Project project = new Project();
                project.setName(jTextFieldName.getText());
                project.setDescription(jTextAreaDescription.getText());
        
                //Chama o controlador para armazenar no banco de dados
