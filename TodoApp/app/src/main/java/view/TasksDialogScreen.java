...
public class TasksDialogScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabelErrorDeadLine.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        ...
        try {
            if(!jTextFieldName.getText().isEmpty() && !jFormattedTextFieldDeadLine.getText().isEmpty()){
                ...
                // Criando uma nova tarefa e adicionando os dados da mesma
                Task task = new Task();
                ...
                // Criando uma variável para formatar a data recebida
                SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
                Date deadline = dateFormat.parse(jFormattedTextFieldDeadLine.getText());
            
                task.setDeadLine(deadline);
            
                // Executando o controlador para salvar essa tarefa no banco de dados
                controller.save(task);
                // Exibindo uma mensagem de exito.
